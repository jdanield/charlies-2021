...
/*
Plugin Name: Charlie's content 3.2.5
Version: 3.2.5
...
if (!isset($charlie['version']) or  $charlie['version'] != CHARLIES_VER) 
{
	...
	if (!isset($charlie['Music'])) 			$charlie['Music'] = array('pls','m3u','mid','au','aif',); 
	if (!isset($charlie['html5wav'])) 			$charlie['html5wav'] = array('wav'); 
