...
** History **
20210222 version 3.2.5 uidentique à 3.2.4-2

20200422 version 3.2.4 - mise à jour getid3, agrandissement des valeurs par défaut des audio et video (modifiables dans html5.tpl et mp3player.tpl)

20190212 Version 3.2.3 - retouche de la hauteur d'affichage dans acrobat.tpl (mise à 100%)

20181229 Version 3.2.2 - updates of version number in main.inc.php and here

20181221 Version 3.2.1 updated getid3 to version 1.9.16 2018-10-17 - all what is under /getid3, nothing else

20170425 Version 3.1.1 date fixed in below php7 (2017, not 2016) - in REDAME-FIRST, plugin folder is piwigo plugins, not piwigo/include

20170404 Version 3.1 code changed thanks to jheinitz to cope with php7. README-FIRTS also changed to add changed config file
